...
#just rearranging columns
df <- df %>%
  select(Month, Year, Date, Water.System.Name, PWSID, Ownership, Max.Withdrawals.mgd)
view(df)
  
#5
#Plot the max daily withdrawals across the months for 2020
ggplot(df, aes(x = Month, y = Max.Withdrawals.mgd)) +
  geom_line() +
  geom_smooth(method="loess",se=FALSE) +
  #FIX THIS
  ylabs = "Max Monthly Withdrawals (mgd)") +
  labs(title = "2020 Water Usage Data")
