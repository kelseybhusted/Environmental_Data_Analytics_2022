...
GaringerOzone.nonSeasonal.ts <- ts(GaringerOzone.Components$trend, start = c(2010,1), frequency = 12)
head(GaringerOzone.monthly.ts, 10)

#Mann Kendall Non-Seasonal
MonthlyOzoneTrend <- Kendall::MannKendall(GaringerOzone.monthly.ts)
MonthlyOzoneTrend
summary(MonthlyOzoneTrend)
#p-value is less than 0.05
#the null hypothesis of the test (i.e., Seasonal Mann Kendall) states that the data is stationary
...
> Answer: The results derived from the non-seasonal and seasonal time series are the same with respect to the tau and p-value (i.e., p-value = 0.33732). Furthremore, the monotonic trend remains the same/constant even with the seasonal component excluded.
