...
library(agricolae)
#Import data
NTL.LTER.chem.phys <- read.csv("./Data/Processed/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv", stringsAsFactors = TRUE)
#Set date
NTL.LTER.chem.phys$sampledate <- as.Date(NTL.LTER.chem.phys$sampledate, format = "%Y-%m-%d")
