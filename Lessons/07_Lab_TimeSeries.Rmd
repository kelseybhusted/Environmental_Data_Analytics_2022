...
#Temperature
Temp_ts_Decomposed <- stl(Temp_ts, s.window = "periodic")
plot(Temp_ts_Decomposed)

Rainfall_ts_Decomposed <- stl(Rainfall_ts, s.window = "periodic")
plot(Rainfall_ts_Decomposed)
...
Temp_Components <- as.data.frame(Temp_ts_Decomposed$time.series[,1:3])
view(Temp_Components)

Rainfall_Components <- as.data.frame(Rainfall_ts_Decomposed$time.series[,1:3])
