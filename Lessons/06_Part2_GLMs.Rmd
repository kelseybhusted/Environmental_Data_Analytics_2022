...
#if p-value is less than 0.05, we reject the null hypothesis meaning that the data for this site does NOT follow normal distribution
...
#we do not reject null hypothesis for site 046; they have a normal distribution
...
#we do not reject null hypothesis for site 057; they have a normal distribution
...
# Post-hoc test
#The Anova test tells you that the means are not the same but the Post-hoc test goes a step further and tells you which means are different specifically
...
```{r}
# Format as aov
#we reject our null hypothesis which means that the mean across our groups are different
