...
EPAair.sites <- EPAair %>% 
  ...
  summarize(
    #Whenever we have NA in our data,we used na.rm=TRUE to get proper results for mean,mode etc
...
#Upgrade to a spatial dataframe (i.e., add attributes)
...
#take something and expand by a number (in this case 1); 1 degree in latitude and longitude
#looks weird because the geometric units of our featur are measured in angular units, not planar  ones
...
#calculate distance between gas stations and air measurements
