...
```{r}
#y is irradiance (i.e., dependent variable) and x is dept (i.e., independent variable)
...
```{r, fig.height = 3, fig.width = 4}
#filtering data to remove zeros and only include < 5000 
...
irradiancebydepth2 <- 
  ...
  scale_y_log10() + #taking log of irradiance
  geom_point() 
...
``` {r, fig.height = 3, fig.width = 4}
#we'll multiple explanatory variables (i.e., x) explaining y
