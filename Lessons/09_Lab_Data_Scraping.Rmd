...
#00060 is discharge while 00065 is gage height
...
scrape.it <- function(the_year){
  ...
  #Fetch the website
  the_website <- read_html(paste0('https://www.eia.gov/electricity/state/', 
                                  the_year))
...
the_df_2017 <- scrape.it(2017)
view(the_df_2017)

# Map the function to scrape data from 2017 to 2020

#Set the inputs to scrape years 2015 to 2020
the_years = rep(2017:2020)

the_dfs_2017to2020 <- map(the_years,scrape.it)

#Conflate the returned dataframes into a single dataframe
the_dfs_2017to2020 <- bind_rows(the_dfs)
